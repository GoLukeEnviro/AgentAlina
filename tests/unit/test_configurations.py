...
class TestEnvironmentConfiguration(unittest.TestCase):
    ...
    def test_get_api_key_existing(self):
        ...
        self.assertEqual(result, 'test_news_key_123')
    ...
    def test_get_trading_config_defaults(self):
        ...
        self.assertIsNone(config['binance_api_key'])
        self.assertIsNone(config['binance_secret_key'])
    ...
    def test_validate_configuration_defaults(self):
        ...
        # Neo4j defaults should be False (using default values)
    ...
    def test_print_configuration_status(self, mock_logger):
        ...
        # Prüfe dass API Key maskiert wurde
        calls = [str(call) for call in mock_logger.info.call_args_list]
        masked_calls = [call for call in calls if 'test_key_' in call and '...' in call]
        self.assertTrue(len(masked_calls) > 0)
    ...
    def test_environment_loading_with_dotenv_file(self):
        ...
        try:
            ...
            # Prüfe dass Werte geladen wurden
